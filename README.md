...
<img src="_doc/exam_rank_03_res.png"/>

## Exam Description:

The exam has 1 project to build, without traces. One random project is requested: gnl or ft_printf(simplified).
...
Write a function named ft_printf that will mimic the real printf but it
will manage only the following conversions:
...
there is one at the end of the line that has been read. When you have reached the EOF, you must store
...
for the read calls in your functions. Your function must be memory leak free. When you have reached the EOF,
